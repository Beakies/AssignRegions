...
1. An input file - formatted Excel sheet with sighting coordinates that requires DFO region assignment and will be checked for land whales. The name of input file needs to be manually updated. 
