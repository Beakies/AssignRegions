...
1. An input file - formatted Excel sheet with two tabs:
    ...
    (B) a tab with the list of species codes and associated species names  

The name of input file needs to be manually updated in this Rmarkdown script in the code block below --->

```{r input file, echo=T}

# Current xls file is specified in quotations here:
input_file <-"Test_species_codes.xlsx"
